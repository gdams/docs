...
[![arm64v8/nuxeo build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/nuxeo.svg?label=arm64v8/nuxeo%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/nuxeo/)
...
```console
$ docker run --name mynuxeo -p 8080:8080 -d arm64v8/nuxeo
```
