...
-	[`v2.0.0-alpha4`, `2.0.0-alpha4`, `v2.0`, `2.0`, `faisselle`](https://github.com/containous/traefik-library-image/blob/443c6cee375ea3e2436b117df8535f05e9854385/scratch/amd64/Dockerfile)
-	[`v2.0.0-alpha4-alpine`, `2.0.0-alpha4-alpine`, `v2.0-alpine`, `2.0-alpine`, `faisselle-alpine`](https://github.com/containous/traefik-library-image/blob/443c6cee375ea3e2436b117df8535f05e9854385/alpine/Dockerfile)
